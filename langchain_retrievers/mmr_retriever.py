...
retriever = vector_store.as_retriever(
    ...
    # lambda_mult = 1 means only relevance is considered, while lambda_mult = 0 means only diversity is considered.
    # if lambda_mult = 1, it will behave like a standard similarity search.
)

query = "Who is the captain of the Indian national cricket team?"
