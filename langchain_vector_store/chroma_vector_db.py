...
# View documents
embeddings = vector_store.get(include = ['metadatas', 'documents'])
print(embeddings)

# search documents
# here, k = 2 means we want to retrieve top 2 similar documents
result = vector_store.similarity_search("Who is Virat Kohli?", k = 2)
print(result)
